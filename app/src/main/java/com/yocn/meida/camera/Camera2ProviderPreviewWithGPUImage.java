 ...
 */
public class Camera2ProviderPreviewWithGPUImage extends BaseCameraProvider {
    ...
    public interface OnGetBitmapInterface {
        public void getABitmap(Bitmap bitmap, byte[] nv21, int width, int height);
    }
    ...
    public Camera2ProviderPreviewWithGPUImage(Activity mContext) {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            try {
                if (mOnGetBitmapInterface != null) {
                    mOnGetBitmapInterface.getABitmap(bitmap, nv21, w, h);
                }
            } catch (Exception e) {
                e.printStackTrace();
